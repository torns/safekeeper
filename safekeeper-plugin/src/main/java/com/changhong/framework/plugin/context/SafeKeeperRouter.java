...
public class SafeKeeperRouter {
	...
	public static boolean isMatch(String pattern, String path) {
		return SafeKeeperManager.getSaTokenContext().matchPath(pattern, path);
	}
	...
	public static boolean isMatchCurrURI(String pattern) {
		return isMatch(pattern, SafeKeeperManager.getSaTokenContext().getRequest().getRequestPath());
	}
	...
	public static boolean isMatchCurrURI(List<String> patterns) {
		return isMatch(patterns, SafeKeeperManager.getSaTokenContext().getRequest().getRequestPath());
	}
